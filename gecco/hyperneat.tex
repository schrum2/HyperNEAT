...
\begin{figure}[htp]
\begin{center}
\includegraphics[scale=.3]{figures/cppn}
\end{center}
...
\begin{figure}[ht]
\begin{center}
\includegraphics[scale=.35]{figures/CondorHyperNEAT}
\end{center}
...
\begin{figure}[ht]
\begin{center}
\includegraphics[scale=.35]{figures/freeway}
\end{center}
...
\begin{figure}[ht]
\begin{center}
\includegraphics[scale=.35]{figures/asterix}
\end{center}
