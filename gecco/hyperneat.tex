...
%% \label{sec:sarsa}
%Throughout the experimental section, HyperNEAT-GGP is compared against the temporal difference reinforcement learning method Sarsa$(\lambda)$. 
...
\newblock Deep blue.
\newblock {\em Artif. Intell.}, 134(1-2):57--83, 2002.
...
\newblock {Generative encoding for multiagent learning}.
...
\newblock {A case study on the critical role of geometric regularity in machine
  learning}.
...
\newblock Backpropagation without human supervision for visual control in quake
  II.
\newblock {\em Proceedings of the 2009 IEEE Symposium on Computational
  Intelligence and Games (CIG'09)}, pages 287--293, 2009.
...
\newblock {\em Adaptive Behavior}, 13(3):165--188, 2005.
...
\newblock Td-gammon, a self-teaching backgammon program, achieves master-level
  play.
\newblock {\em Neural Comput.}, 6:215--219, March 1994.

\bibitem{verbancsics10}
P.~Verbancsics and K.~O. Stanley.
\newblock Evolving static representations for task transfer.
\newblock {\em J. Mach. Learn. Res.}, 11:1737--1769, August 2010.
