...
enum ExperimentType
{
    ...
    EXPERIMENT_ATARI_HYBRID=33,
    EXPERIMENT_ATARI_INTRINSIC=34,
    EXPERIMENT_ATARI_PIXEL=35,
    EXPERIMENT_ATARI_NOISE=36,
    EXPERIMENT_ATARI_FT_NEAT_PIXEL=37,
    EXPERIMENT_ATARI_FT_NEAT_NOISE=38,
    EXPERIMENT_ATARI_NO_GEOM_PIXEL=39,
    EXPERIMENT_ATARI_NO_GEOM_NOISE=40,
    EXPERIMENT_ATARI_CMA=41,
    EXPERIMENT_ATARI_PIXEL_PREFERENCE_MODULES=42, 	// Schrum: added for multimodal evolution
    EXPERIMENT_END
};
