...
namespace HCUBE
{
    AtariNoGeomNoiseExperiment::AtariNoGeomNoiseExperiment(string _experimentName,int _threadID):
    ...
    void AtariNoGeomNoiseExperiment::initializeTopology() {
    ...
    void AtariNoGeomNoiseExperiment::setSubstrateValues() {
